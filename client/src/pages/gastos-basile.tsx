  ...
  const saveExtractMutation = useMutation({
    mutationFn: async (transactions: ClassifiedTransaction[]) => {
      ...
      const bankTransactionsToSave: InsertBankTransactionPersistent[] = transactions.map(t => ({
        ...
        categoriaOrigemExtrato: t.categoriaOrigemExtrato,
        categoriaMacro: t.categoriaMacro || t.categoria,
        categoriaAnaliticaFinal: t.categoriaAnaliticaFinal || t.categoria,
        regraAplicada: t.regraAplicada,
        confidenceScore: t.confidenceScore?.toString(),
        requiresReview: t.requiresReview ? 1 : 0,
        mes: t.mes,
        ano: t.ano,
        isoWeek: t.isoWeek,
        source: 'bank_import'
